# Mapa de versiones — Módulo de Innovación curricular (PHP)
...
|---|---|---|
| **v1** | `aliado` de punta a punta: los 5 verbos, el borrado lógico, la pantalla y la prueba de capas | **hecha** |
...
## Por qué la v1 es `aliado`

De las tablas **sin clave foránea** del módulo, es la que más enseña:

- tiene **6 columnas** —suficientes para que el
...
Las 25 tablas del módulo **se crean todas** en el primer
arranque: la base es infraestructura dada (Artículo 5). Lo que crece por
versiones es la API, no el esquema.

## Y el gemelo

[`proyecto_paradigmas_innovacion_curricular1`](../../../../proyecto_paradigmas_innovacion_curricular1) construye esta
