# Investigación y decisiones — v1: `aliado` (PHP)
...
**Contexto.** El mismo módulo existe en `proyecto_paradigmas_innovacion_curricular1`,
sobre PostgreSQL.
...
1. **El script que el curso entrega para este módulo es MySQL**:
   `ProyectosDeAula/db_scripts/mysql/innovacion_curricular.sql`, y el modelo
...
`activo` a las 22 tablas del módulo y borrar lógicamente.
...
**Contexto.** La ficha tiene 6 campos.

**Decisión.** El listado muestra 5 columnas
