# Modelo de datos — v1: `aliado` (MariaDB)

## 1. La tabla

| Columna | Tipo | |
|---|---|---|
| `nit` | `INT` | **Llave primaria** |
| `razon_social` | `VARCHAR(60)` | No nulo |
| `nombre_contacto` | `VARCHAR(60)` | No nulo |
| `correo` | `VARCHAR(70)` | No nulo |
| `telefono` | `VARCHAR(45)` | No nulo |
...
| C4 | Las 22 tablas del módulo ganan `activo` | El borrado es lógico (Artículo 6) |
...
No está en el modelo `Aliado`, no viaja en el JSON, y **no está en la
