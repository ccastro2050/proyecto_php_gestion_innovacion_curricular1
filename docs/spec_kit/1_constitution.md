# Constitución del proyecto — Módulo de Innovación curricular, en PHP
...
Este repositorio construye el módulo de **Innovación curricular** del proyecto de
aula, en **PHP puro sobre MariaDB**. Su gemelo,
[`proyecto_paradigmas_innovacion_curricular1`](../../../proyecto_paradigmas_innovacion_curricular1), construye el
...
| Puertos | front **8114** · API **8115** · MariaDB **13332** · phpMyAdmin **8107** | otros |
...
`require_once __DIR__ . '/../api_innovacion/modelos/Aliado.php'` para usar
...
- El servicio depende de `IRepositorioAliado`, **la interfaz**, nunca
...
(`ProyectosDeAula/db_scripts/mysql/innovacion_curricular.sql`). Este proyecto
...
| Interfaces | `I` delante: `IServicioAliado` |
...
Una ruta por recurso: `/api/aliado`. **No** existe ni existirá
...
Lo mismo del lado del front: `listar_innovacion()`, no `listar($tabla)`.
