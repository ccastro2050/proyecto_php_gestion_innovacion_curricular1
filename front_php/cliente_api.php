 ...
 *
 * para usar aquí la clase `Aliado` de la API. Funcionaría. Y estaría mal: los
...
define('URL_API', getenv('URL_API') ?: 'http://localhost:8115');
 ...
 * (proyecto_paradigmas_innovacion_curricular1) envuelve todo eso dentro de
...
// ======================================================================
// LAS CINCO OPERACIONES SOBRE `aliado`
//
...
function listar_innovacion(int $limite = 1000): array
{
    $r = llamar_api('GET', "/api/aliado?limite=$limite");
...
/** RF2 — Obtener uno por su nit. */
function obtener_innovacion(string $clave): array
{
    $r = llamar_api('GET', '/api/aliado/' . rawurlencode($clave));
...
/** RF3 — Crear. */
function crear_innovacion(array $datos): array
{
    return resultado_de(llamar_api('POST', '/api/aliado', $datos));
}
 ...
 */
function reemplazar_innovacion(string $clave, array $datos): array
{
    return resultado_de(llamar_api('PUT', '/api/aliado/' . rawurlencode($clave), $datos));
}
 ...
 */
function actualizar_innovacion(string $clave, array $datos): array
{
    return resultado_de(llamar_api('PATCH', '/api/aliado/' . rawurlencode($clave), $datos));
}
 ...
 */
function eliminar_innovacion(string $clave): array
{
    return resultado_de(llamar_api('DELETE', '/api/aliado/' . rawurlencode($clave)));
}
