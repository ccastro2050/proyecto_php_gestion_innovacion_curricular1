...
<div class="p-4 p-md-5 mb-4 bg-white border rounded-3 shadow-sm">
  <h1 class="display-6 fw-semibold">Sistema de innovación curricular</h1>
  <p class="fs-5 text-body-secondary mb-0">
    Los aliados con los que el currículo se renueva.
  </p>
</div>
...
<div class="row g-3">
  <div class="col-md-6">
    <div class="card h-100 shadow-sm">
      <div class="card-body">
        <h2 class="card-title h5">Aliados</h2>
        <p class="card-text text-body-secondary">
          6 datos por ficha. Se pueden agregar, corregir y retirar.
          Retirar no destruye nada: la ficha se queda en la base y deja de
          aparecer.
        </p>
      </div>
      <div class="card-footer bg-transparent border-0 pb-3">
        <a class="btn btn-primary" href="/aliados">Ver aliados</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="card h-100 bg-body-tertiary">
      <div class="card-body">
        ...
        <p class="card-text text-body-secondary">
          El módulo tiene <strong>25</strong> tablas y esta versión
