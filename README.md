# Módulo de Innovación curricular — versión 1, en PHP

El módulo de **innovación curricular** del proyecto de aula, construido en
...
|---|---|
| **La pantalla** — empiece por aquí | **http://localhost:8114** |
| La API — diagnóstico | http://localhost:8115/ |
| La API — el listado | http://localhost:8115/api/aliado |
| phpMyAdmin (mirar la base por dentro) | http://localhost:8107 |
| MariaDB (HeidiSQL, DBeaver…) | `localhost:13332` · usuario `innovacion` |

## Qué trae la v1

El CRUD completo de **`aliado`** de punta a punta: enrutador,
...
[quickstart](docs/spec_kit/versiones/v1_aliado/7_quickstart.md) trae la
...
| Campo | Tipo | |
|---|---|---|
| `nit` | entero | obligatorio |
| `razon_social` | texto (60) | obligatorio |
| `nombre_contacto` | texto (60) | obligatorio |
| `correo` | texto (70) | obligatorio |
| `telefono` | texto (45) | obligatorio |
| `ciudad` | texto (45) | obligatorio |

## El gemelo en Python

Este mismo módulo, con el mismo contrato sobre la misma tabla, está también
en [`proyecto_paradigmas_innovacion_curricular1`](../proyecto_paradigmas_innovacion_curricular1) — pero en
...
```
api_innovacion/                     LA API: PHP puro + PDO
...
db/init.sql                      las 25 tablas + las semillas, derivado del script del curso
...
| [Especificación de la v1](docs/spec_kit/versiones/v1_aliado/2_spec.md) | Requisitos y criterios de aceptación |
| [Contratos](docs/spec_kit/versiones/v1_aliado/6_contracts.md) | Cada ruta con sus desenlaces, incluidos los de error |
| [Quickstart](docs/spec_kit/versiones/v1_aliado/7_quickstart.md) | Los siete criterios, comprobados a mano |
| [Guía de IA](docs/spec_kit/versiones/v1_aliado/GUIA_IA1.md) | El prompt para reconstruir esta versión desde cero |
